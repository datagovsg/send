...
export default function(state, emitter) {
  ...
  emitter.on("addFiles", async ({ files }) => {
    const fileTypes = ['.doc', '.docx', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', '.csv', '.xls', '.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', ' application/vnd.ms-excel', 'application/vnd.ms-powerpoint', '.pptx', '.ppt', 'audio/*', 'video/*', 'image/*', 'application/pdf'];
