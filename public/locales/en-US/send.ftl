...
fileMissingExtension = A file '{ $file }' is missing an extension. Only files with valid extensions are allowed.
fileInvalidExtension = A file '{ $file }' has an invalid extension of '{ $type }' which is not allowed.
